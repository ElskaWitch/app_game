<section class="py-16 ">
    <a href="user.php" class="text-blue-500 text-sm">
        retour </a>
    <?php $main_title = "Ajouter un user";
    include("_h1.php")
    ?>
    <form action="" method="POST" class="grid place-items-center bg-gray-100 mx-96 py-10 my-16 gap-y-4 rounded-xl" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" step="0.01" name="email" class="input input-bordered w-full max-w-xs block" value="<?php
        ...
        <div class="mb-4">
            ...
            <input type="text" step="0.01" name="password" class="input input-bordered w-full max-w-xs block" value="<?php
